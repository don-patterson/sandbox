...
taken from: https://raw.githubusercontent.com/remcohaszing/pywakeonlan/master/wakeonlan.py
I want to strip this down to just pieces that I need/understand.
